...
cd pumpbot
npm install
npm test                     # 290 offline checks, no network or keys needed
...
| `npm run reset` | Clear the paper book for a clean measurement (paper only) |
